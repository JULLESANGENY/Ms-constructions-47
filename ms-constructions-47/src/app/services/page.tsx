                ...
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-gray-600">{service.shortDesc}</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-gray-50 rounded-lg p-4 mb-6">
                    <p className="text-sm text-gray-600 mb-1">Tarification indicative :</p>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-secondary-600">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="tel:+33553123456">Appeler maintenant</Link>
            </Button>
          </div>
        </div>
      </section>
