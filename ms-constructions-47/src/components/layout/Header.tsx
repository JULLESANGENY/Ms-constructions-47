        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-primary-600 font-semibold">47</span>
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            >
              <Link
                href="/contact"
                className="bg-primary-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-primary-700 transition-colors duration-200 shadow-sm hover:shadow-md"
              >
                Devis gratuit
              </Link>
            </motion.div>
